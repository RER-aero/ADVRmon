function ADVR.onLoad()
    pickup.name = "Weakness Policy"
    pickup.desc = "An item to be held by a Pokémon. This policy boosts the holder's Attack stat for a while if the holder is hit with a move it's weak to."
	pickup.weight = 80
	pickup.tier = 2
	pickup.maxAmount = 5
	pickup.amountUses = -1
