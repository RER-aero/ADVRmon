function ADVR.onLoad()
    pickup.name = "Macho Brace"
    pickup.desc = "An item to be held by a Pokémon. This stiff, heavy brace helps Pokémon grow strong but cuts attack Speed in battle. "
	pickup.weight = 80
	pickup.tier = 2
	pickup.maxAmount = 1
	pickup.amountUses = -1
	pickup.price = 15
	pickup.spawnsIn = {relicPool.SACRIFICE, relicPool.SHOP, relicPool.PODEST}
